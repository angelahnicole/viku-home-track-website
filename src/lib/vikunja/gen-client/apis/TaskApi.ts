...
import {
    ...
    ModelsTaskBucketFromJSON,
    ModelsTaskBucketToJSON,
...
export interface ProjectsProjectViewsViewBucketsBucketTasksPostRequest {
    project: number;
    view: number;
    bucket: number;
...
export class TaskApi extends runtime.BaseAPI {
    ...
    async kindIdReactionsDeletePostRaw(requestParameters: KindIdReactionsDeletePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsMessage>> {
        ...
        let urlPath = `/{kind}/{id}/reactions/delete`;
    ...
    async projectsIdViewsViewTasksGetRaw(requestParameters: ProjectsIdViewsViewTasksGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ModelsTask>>> {
        ...
        let urlPath = `/projects/{id}/views/{view}/tasks`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
        urlPath = urlPath.replace(`{${"view"}}`, encodeURIComponent(String(requestParameters['view'])));
     ...
     */
    async projectsProjectViewsViewBucketsBucketTasksPostRaw(requestParameters: ProjectsProjectViewsViewBucketsBucketTasksPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsTaskBucket>> {
        if (requestParameters['project'] == null) {
            throw new runtime.RequiredError(
                'project',
                'Required parameter "project" was null or undefined when calling projectsProjectViewsViewBucketsBucketTasksPost().'
            );
        }
        ...
        if (requestParameters['view'] == null) {
            throw new runtime.RequiredError(
                'view',
                'Required parameter "view" was null or undefined when calling projectsProjectViewsViewBucketsBucketTasksPost().'
            );
        }
        ...
        if (requestParameters['bucket'] == null) {
            throw new runtime.RequiredError(
                'bucket',
                'Required parameter "bucket" was null or undefined when calling projectsProjectViewsViewBucketsBucketTasksPost().'
            );
        }

        if (requestParameters['taskBucket'] == null) {
            throw new runtime.RequiredError(
                'taskBucket',
                'Required parameter "taskBucket" was null or undefined when calling projectsProjectViewsViewBucketsBucketTasksPost().'
            );
        }
        ...
        let urlPath = `/projects/{project}/views/{view}/buckets/{bucket}/tasks`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ModelsTaskBucketToJSON(requestParameters['taskBucket']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ModelsTaskBucketFromJSON(jsonValue));
    }
     ...
     * Update a task bucket
     */
    async projectsProjectViewsViewBucketsBucketTasksPost(requestParameters: ProjectsProjectViewsViewBucketsBucketTasksPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelsTaskBucket> {
        const response = await this.projectsProjectViewsViewBucketsBucketTasksPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async tasksIdAttachmentsAttachmentIDDeleteRaw(requestParameters: TasksIdAttachmentsAttachmentIDDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsMessage>> {
        ...
        let urlPath = `/tasks/{id}/attachments/{attachmentID}`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async tasksIdAttachmentsAttachmentIDGetRaw(requestParameters: TasksIdAttachmentsAttachmentIDGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        ...
        if (requestParameters['previewSize'] != null) {
            queryParameters['preview_size'] = requestParameters['previewSize'];
        }
    ...
    async tasksIdAttachmentsGetRaw(requestParameters: TasksIdAttachmentsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ModelsTaskAttachment>>> {
        ...
        let urlPath = `/tasks/{id}/attachments`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async tasksTaskIDCommentsCommentIDDeleteRaw(requestParameters: TasksTaskIDCommentsCommentIDDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsMessage>> {
        ...
        let urlPath = `/tasks/{taskID}/comments/{commentID}`;
    ...
    async tasksTaskIDCommentsGetRaw(requestParameters: TasksTaskIDCommentsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ModelsTaskComment>>> {
        ...
        let urlPath = `/tasks/{taskID}/comments`;
        urlPath = urlPath.replace(`{${"taskID"}}`, encodeURIComponent(String(requestParameters['taskID'])));
    ...
    async tasksTaskIDRelationsPutRaw(requestParameters: TasksTaskIDRelationsPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsTaskRelation>> {
        ...
        let urlPath = `/tasks/{taskID}/relations`;
        urlPath = urlPath.replace(`{${"taskID"}}`, encodeURIComponent(String(requestParameters['taskID'])));
    ...
    async tasksTaskIDRelationsRelationKindOtherTaskIDDeleteRaw(requestParameters: TasksTaskIDRelationsRelationKindOtherTaskIDDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelsMessage>> {
        ...
        let urlPath = `/tasks/{taskID}/relations/{relationKind}/{otherTaskID}`;
        urlPath = urlPath.replace(`{${"taskID"}}`, encodeURIComponent(String(requestParameters['taskID'])));
        urlPath = urlPath.replace(`{${"relationKind"}}`, encodeURIComponent(String(requestParameters['relationKind'])));
        urlPath = urlPath.replace(`{${"otherTaskID"}}`, encodeURIComponent(String(requestParameters['otherTaskID'])));
