...
export function ModelsTaskRelationToJSON(json: any): ModelsTaskRelation {
    return ModelsTaskRelationToJSONTyped(json, false);
}

export function ModelsTaskRelationToJSONTyped(value?: ModelsTaskRelation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
