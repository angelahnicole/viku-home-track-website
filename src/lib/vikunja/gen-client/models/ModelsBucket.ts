...
export function ModelsBucketToJSON(json: any): ModelsBucket {
    return ModelsBucketToJSONTyped(json, false);
}

export function ModelsBucketToJSONTyped(value?: ModelsBucket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
