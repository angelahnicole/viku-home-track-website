 ...
 */
export function instanceOfModelsSubscription(value: object): value is ModelsSubscription {
    return true;
}
...
export function ModelsSubscriptionToJSON(json: any): ModelsSubscription {
    return ModelsSubscriptionToJSONTyped(json, false);
}

export function ModelsSubscriptionToJSONTyped(value?: ModelsSubscription | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
