...
export function ModelsTaskAssgineeToJSON(json: any): ModelsTaskAssginee {
    return ModelsTaskAssgineeToJSONTyped(json, false);
}

export function ModelsTaskAssgineeToJSONTyped(value?: ModelsTaskAssginee | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
