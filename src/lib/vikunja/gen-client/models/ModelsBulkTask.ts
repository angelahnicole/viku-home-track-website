...
import {
    ...
    ModelsTaskAttachmentToJSONTyped,
 ...
 * 
 * @export
 * @interface ModelsBulkTask
 */
export interface ModelsBulkTask {
    /**
     * An array of users who are assigned to this task
     * @type {Array<UserUser>}
     * @memberof ModelsBulkTask
     */
     ...
     * @type {Array<ModelsTaskComment>}
     * @memberof ModelsBulkTask
     */
    comments?: Array<ModelsTaskComment>;
    /**
...
/**
 * Check if a given object implements the ModelsBulkTask interface.
 */
export function instanceOfModelsBulkTask(value: object): value is ModelsBulkTask {
    return true;
}

export function ModelsBulkTaskFromJSON(json: any): ModelsBulkTask {
    return ModelsBulkTaskFromJSONTyped(json, false);
}

export function ModelsBulkTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsBulkTask {
    if (json == null) {
        return json;
    }
    return {
        ...
        'buckets': json['buckets'] == null ? undefined : ((json['buckets'] as Array<any>).map(ModelsBucketFromJSON)),
        'comments': json['comments'] == null ? undefined : ((json['comments'] as Array<any>).map(ModelsTaskCommentFromJSON)),
...
export function ModelsBulkTaskToJSON(json: any): ModelsBulkTask {
    return ModelsBulkTaskToJSONTyped(json, false);
}

export function ModelsBulkTaskToJSONTyped(value?: ModelsBulkTask | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'buckets': value['buckets'] == null ? undefined : ((value['buckets'] as Array<any>).map(ModelsBucketToJSON)),
        'comments': value['comments'] == null ? undefined : ((value['comments'] as Array<any>).map(ModelsTaskCommentToJSON)),
