 ...
 */
export function instanceOfUserPasswordReset(value: object): value is UserPasswordReset {
    return true;
}
...
export function UserPasswordResetToJSON(json: any): UserPasswordReset {
    return UserPasswordResetToJSONTyped(json, false);
}

export function UserPasswordResetToJSONTyped(value?: UserPasswordReset | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
