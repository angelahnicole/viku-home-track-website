...
export function ModelsTaskCollectionToJSON(json: any): ModelsTaskCollection {
    return ModelsTaskCollectionToJSONTyped(json, false);
}

export function ModelsTaskCollectionToJSONTyped(value?: ModelsTaskCollection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
