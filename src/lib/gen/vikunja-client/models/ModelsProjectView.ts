...
import {
    ...
    ModelsProjectViewBucketConfigurationToJSONTyped,
...
import {
    ...
    ModelsTaskCollectionToJSONTyped,
...
export interface ModelsProjectView {
     ...
     * @memberof ModelsProjectView
     */
    bucketConfigurationMode?: ModelsProjectViewBucketConfigurationModeEnum;
    /**
     ...
     * @memberof ModelsProjectView
     */
    viewKind?: ModelsProjectViewViewKindEnum;
}
 ...
 * @export
 */
export const ModelsProjectViewBucketConfigurationModeEnum = {
    None: 'none',
    Manual: 'manual',
    Filter: 'filter',
    Manual2: 'manual'
} as const;
export type ModelsProjectViewBucketConfigurationModeEnum = typeof ModelsProjectViewBucketConfigurationModeEnum[keyof typeof ModelsProjectViewBucketConfigurationModeEnum];

/**
 * @export
 */
export const ModelsProjectViewViewKindEnum = {
    List: 'list',
    Gantt: 'gantt',
    Table: 'table',
    Kanban: 'kanban'
} as const;
export type ModelsProjectViewViewKindEnum = typeof ModelsProjectViewViewKindEnum[keyof typeof ModelsProjectViewViewKindEnum];
...
export function ModelsProjectViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsProjectView {
    ...
    return {
        ...
        'bucketConfigurationMode': json['bucket_configuration_mode'] == null ? undefined : json['bucket_configuration_mode'],
        ...
        'filter': json['filter'] == null ? undefined : ModelsTaskCollectionFromJSON(json['filter']),
        'id': json['id'] == null ? undefined : json['id'],
        'position': json['position'] == null ? undefined : json['position'],
        'projectId': json['project_id'] == null ? undefined : json['project_id'],
        'title': json['title'] == null ? undefined : json['title'],
        'updated': json['updated'] == null ? undefined : json['updated'],
        'viewKind': json['view_kind'] == null ? undefined : json['view_kind'],
    };
}

export function ModelsProjectViewToJSON(json: any): ModelsProjectView {
    return ModelsProjectViewToJSONTyped(json, false);
}

export function ModelsProjectViewToJSONTyped(value?: ModelsProjectView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'bucket_configuration_mode': value['bucketConfigurationMode'],
        'created': value['created'],
        'default_bucket_id': value['defaultBucketId'],
        'done_bucket_id': value['doneBucketId'],
        'filter': ModelsTaskCollectionToJSON(value['filter']),
        'id': value['id'],
        'position': value['position'],
        'project_id': value['projectId'],
        'title': value['title'],
        'updated': value['updated'],
        'view_kind': value['viewKind'],
    };
}
