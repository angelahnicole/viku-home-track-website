...
export function ModelsLabelToJSON(json: any): ModelsLabel {
    return ModelsLabelToJSONTyped(json, false);
}

export function ModelsLabelToJSONTyped(value?: ModelsLabel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
