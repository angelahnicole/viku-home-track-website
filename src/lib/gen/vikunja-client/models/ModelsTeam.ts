...
export function ModelsTeamToJSON(json: any): ModelsTeam {
    return ModelsTeamToJSONTyped(json, false);
}

export function ModelsTeamToJSONTyped(value?: ModelsTeam | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
