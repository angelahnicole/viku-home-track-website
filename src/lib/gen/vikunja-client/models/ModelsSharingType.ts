...
export function instanceOfModelsSharingType(value: any): boolean {
    for (const key in ModelsSharingType) {
        if (Object.prototype.hasOwnProperty.call(ModelsSharingType, key)) {
            if (ModelsSharingType[key as keyof typeof ModelsSharingType] === value) {
                return true;
            }
        }
    }
...
export function ModelsSharingTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): ModelsSharingType {
    return value as ModelsSharingType;
}
