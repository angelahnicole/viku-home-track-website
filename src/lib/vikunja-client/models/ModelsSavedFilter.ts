...
export function ModelsSavedFilterToJSON(json: any): ModelsSavedFilter {
    return ModelsSavedFilterToJSONTyped(json, false);
}

export function ModelsSavedFilterToJSONTyped(value?: ModelsSavedFilter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
