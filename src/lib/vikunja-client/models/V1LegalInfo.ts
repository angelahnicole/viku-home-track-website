...
export function V1LegalInfoToJSON(json: any): V1LegalInfo {
    return V1LegalInfoToJSONTyped(json, false);
}

export function V1LegalInfoToJSONTyped(value?: V1LegalInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
