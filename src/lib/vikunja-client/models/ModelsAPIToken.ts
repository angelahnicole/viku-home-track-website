...
export function ModelsAPITokenToJSON(json: any): ModelsAPIToken {
    return ModelsAPITokenToJSONTyped(json, false);
}

export function ModelsAPITokenToJSONTyped(value?: ModelsAPIToken | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
