...
export function ModelsTeamWithRightToJSON(json: any): ModelsTeamWithRight {
    return ModelsTeamWithRightToJSONTyped(json, false);
}

export function ModelsTeamWithRightToJSONTyped(value?: ModelsTeamWithRight | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
