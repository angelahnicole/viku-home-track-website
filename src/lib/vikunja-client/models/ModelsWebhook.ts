...
export function ModelsWebhookToJSON(json: any): ModelsWebhook {
    return ModelsWebhookToJSONTyped(json, false);
}

export function ModelsWebhookToJSONTyped(value?: ModelsWebhook | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
