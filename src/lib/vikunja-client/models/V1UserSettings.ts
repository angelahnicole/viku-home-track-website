...
export function V1UserSettingsToJSON(json: any): V1UserSettings {
    return V1UserSettingsToJSONTyped(json, false);
}

export function V1UserSettingsToJSONTyped(value?: V1UserSettings | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
