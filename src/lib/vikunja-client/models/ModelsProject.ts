...
export function ModelsProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelsProject {
    ...
    return {
        ...
        'maxRight': json['max_right'] == null ? undefined : ModelsRightFromJSON(json['max_right']),
...
export function ModelsProjectToJSON(json: any): ModelsProject {
    return ModelsProjectToJSONTyped(json, false);
}

export function ModelsProjectToJSONTyped(value?: ModelsProject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'max_right': ModelsRightToJSON(value['maxRight']),
