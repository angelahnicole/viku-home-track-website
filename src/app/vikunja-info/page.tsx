    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-8">
            <div className="w-full max-w-xl rounded-lg bg-white p-8 shadow-md">
                <h1 className="mb-6 text-3xl font-bold text-blue-700">Vikunja Info</h1>
                <Button
                    variant="contained"
                    color="primary"
                    onClick={fetchInfo}
                ...
                {info && (
                    <pre className="mt-4 overflow-x-auto rounded border border-gray-800 bg-gray-900 p-4 text-sm text-gray-100 shadow-inner">
